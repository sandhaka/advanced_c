...
In the following example the function `fn` is used as thread body. At the end of his work, the function join back to the caller with the `retval` variable as result.
